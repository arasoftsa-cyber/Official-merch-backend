...
module.exports = {
  forbidden: [
    ...
    {
      name: 'modules-no-config-middleware',
      severity: 'error',
      from: { path: '^src/modules/' },
      to: { path: '^src/(config|middleware|policies)/' }
    },
    ...
    {
      name: 'no-cross-module-imports-except-api',
      severity: 'error',
      comment: 'Modules may only import other modules via their public *.api.js surface.',
      from: { path: '^src/modules/([^/]+)/' },
      to: {
        path: '^src/modules/[^/]+/',
        pathNot: [
...
// generated: dependency-cruiser@17.3.8 on 2026-03-01T22:56:19.338Z
